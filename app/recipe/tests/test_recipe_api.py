...
def detail_url(recipe_id):
    """Create and return the detail url of recipe."""
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_updating_user_returns_error(self):
        ...
        new_user = create_user(email='user2@example.com', password='testuser123')
        recipe = create_recipe(user=self.user)
    ...
    def test_create_recipe_with_existing_tags(self):
        ...
        tag_ = Tag.objects.create(user=self.user, name='Indian')
        payload = {
            'title': 'Pongal',
            'time_minutes': 60,
            'price': Decimal('4.50'),
        ...
        recipe =  recipes[0]
        self.assertEqual(recipe.tags.count(),2)
        self.assertIn(tag_, recipe.tags.all())
        for tag in payload['tags']:
            exists = recipe.tags.filter(
                name = tag['name'],
                user = self.user,
    ...
    def test_create_ingredient_on_update(self):
        """Test creating a ingredient on updating a recipe"""
        recipe = create_recipe(user=self.user)
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title="Thai Vegetable Curry")
        r2 = create_recipe(user=self.user, title="Biryani")
        in1 = Ingredient.objects.create(user=self.user, name="vegetables")
